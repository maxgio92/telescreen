...
- [Configuration](guides/configuration.md) (3 min): which file to
...
- [CLI reference](reference/telescreen.md): every command and flag.
  The `telescreen_*.md` pages are generated by `make docs`;
  [configuration.md](reference/configuration.md) is hand-written.
